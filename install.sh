...
echo ""
echo "Optional — enable shell completions:"
echo "  bash:  source <(sage completion bash)"
echo "  zsh:   sage completion zsh > \"\${fpath[1]}/_sage\""
echo "  fish:  sage completion fish | source"
